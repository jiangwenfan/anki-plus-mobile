  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      body: Column(children: [
        TextField(
                decoration: InputDecoration(labelText: '技术名称',),
                onChanged: (value){
                  setState((){
                    name = value;
                  })
        ...
        ElevatedButton(
          onPressed: (){
            print("创建分类数据-> name:${name} ttype:${_selectedItem} ${cover_url}");
            createCategory({
              "name":name,
              "ttype":_selectedItem,
              "cover_url":cover_url
...
class AddQuestionPage extends StatefulWidget{
  @override
  State<AddQuestionPage> createState() => AddCategoryPageState();
}

class AddCategoryPageState extends State<AddQuestionPage>{
  /*
  {
  "question": "string",
  "answer": "string",
